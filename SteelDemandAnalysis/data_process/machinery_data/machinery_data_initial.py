...
def machinery_year_on_year_data():
    ...
    #               产量:铁路机车:同比增长（月）
    #               产量:电工仪器仪表:同比增长（月）
    data_path = path_config.machinery_year_on_year_data
    ...
    return machinery_year_on_year_df[
               ['产量:金属切削机床:同比增长（月）', '产量:发电设备:同比增长（月）',
                '产量:铁路机车:同比增长（月）',
                '产量:电工仪器仪表:同比增长（月）']].loc[param_config.begin_time:param_config.end_time]
...
def machinery_cumulative_year_on_year_data():
    ...
    return machinery_cumulative_year_on_year_df[
               ['产量:金属切削机床:累计同比（月）', '产量:发电设备:累计同比（月）',
                '产量:铁路机车:累计同比（月）',
                '产量:电工仪器仪表:累计同比（月）']].loc[param_config.begin_time:param_config.end_time]
